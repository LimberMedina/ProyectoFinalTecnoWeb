...
<template>
    <div class="min-vh-100 d-flex flex-column">
        ...
        <div class="d-flex flex-column flex-grow-1 bg-light">
            ...
            >
                <div class="container-fluid px-3 px-md-4 position-static">
                    ...
                    <Link
                        ...
                        class="navbar-brand me-3 me-md-4"
                    >
                        <ApplicationLogo
                    ...
                    >
                        <ul
                            class="navbar-nav flex-wrap align-items-center w-100 position-static"
                        >
                            <template v-for="item in menuItems" :key="item.id">
                                ...
                                <li v-else class="nav-item position-relative">
                                    ...
                                    >
                                        ...
                                        ></i>
                                        {{ item.label }}
                                        <!-- Mostrar contador en el carrito (desktop) -->
                                        <span
                                            v-if="
                                                item.route ===
                                                    'carritos.index' &&
                            ...
                            <!-- Search Box (Desktop) -->
                            <li
                                class="nav-item d-none d-lg-flex align-items-center me-2 flex-shrink-0"
                                style="flex: 0 1 auto; max-width: 400px"
                            >
                                <SearchBox />
                            </li>
                            ...
                            <li class="nav-item flex-shrink-0 position-static">
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        >
                                            <i
                                                class="bi bi-person-circle me-1 fs-5"
                                            ></i>
                                            {{ $page.props.auth.user.name }}
                                        </button>
                                    </template>
                    ...
                    <div class="mt-2">
                        <template v-for="item in menuItems" :key="item.id">
                            ...
                            >
                                ...
                                <!-- Mostrar contador en el carrito (móvil) -->
                                <span
                                    v-if="
            ...
            <header
                v-if="$slots.header"
                class="bg-white shadow-sm border-bottom flex-shrink-0"
            >
            ...
            <footer
                class="mt-auto py-3 py-md-4 bg-white border-top shadow-sm flex-shrink-0"
            >
                    ...
                    <div class="row align-items-center g-2">
                        ...
                        >
                            <small class="text-muted">
                                ...
                                <strong>{{
                                    $page.props.pageVisits?.current?.toLocaleString() ||
                                    0
                                }}</strong>
                            </small>
                        </div>
                        <div class="col-md-6 text-center text-md-end">
                            <small class="text-muted">
                                ...
                                <strong>{{
                                    $page.props.pageVisits?.total?.toLocaleString() ||
                                    0
                                }}</strong>
                            </small>
                        </div>
