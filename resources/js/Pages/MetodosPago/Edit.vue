...
watch(
    () => props.metodoPago,
    (metodoPago) => {
        form.nombre = metodoPago?.nombre || "";
        form.descripcion = metodoPago?.descripcion || "";
    },
    { immediate: true },
);
...
<template>
    <Head :title="`Editar método: ${metodoPago.nombre}`" />

    <AppLayout :title="`Editar método: ${metodoPago.nombre}`">
        <FlashNotification />
            ...
            <div class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
                ...
                >
                    <div>
                        ...
                        >
                            Actualiza el nombre o la descripción del método de
                            pago.
                        </p>
                    </div>
