                    ...
                    >
                        ...
                        <div class="mt-6">
                            ...
                            >
                                ...
                                ></i>
                                No hay productos seleccionados. Agrega al menos
                                1 producto.
                            </div>
                        </div>
                    </section>
                    ...
                    >
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                            ...
                            <div class="flex items-end">
                                <label
                                    class="inline-flex w-full items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-700"
                                >
                                    <input
                                    ...
                                    />
                                    <span>Confirmar inmediatamente</span>
                                </label>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <strong>Pago a crédito:</strong> Se generará un
                            crédito al confirmar el pedido.
                        </div>
                    </section>
