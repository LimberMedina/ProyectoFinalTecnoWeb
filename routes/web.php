...
Route::middleware([
    ...
    // API para obtener menÃº dinÃ¡mico
    ...
    // Pedidos - Checkout y confirmaciÃ³n
    ...
    Route::prefix('carrito')->name('cart.')->group(function () {
        ...
        // Pagos QR para cuotas de crÃ©ditos - permitir Cliente, Propietario y Vendedor
    ...
    // ============================================
    // MÃ“DULOS CRUD COMPLETO - SOLO PROPIETARIO
    // ============================================
    Route::middleware('role:Propietario')->group(function () {
        // Productos (CRUD completo con URLs en espaÃ±ol, solo para propietario)
        ...
        // CategorÃ­as (CRUD completo con URLs en espaÃ±ol)
        ...
        // Promociones (CRUD completo - movido aquÃ­ para consistencia con Productos/CategorÃ­as)
        ...
        // Usuarios (CRUD completo con URLs en espaÃ±ol)
        ...
        // MÃ©todos de Pago (CRUD completo)
        Route::resource('metodos-pago', MetodoPagoController::class);

        // CrÃ©ditos (editar y eliminar)
    ...
    // CrÃ©ditos - Propietario y Vendedor
    Route::middleware('role:Propietario,Vendedor')->group(function () {
    ...
    // GestiÃ³n de Pedidos - Propietario y Vendedor
    Route::middleware('role:Propietario,Vendedor')->group(function () {
    ...
    // Mis CrÃ©ditos y Pagos - Solo Cliente
    Route::middleware('role:Cliente')->group(function () {
        ...
        Route::post('/mis-pedidos/{id}/confirmar', [\App\Http\Controllers\MisPedidosController::class, 'confirmarRecibido'])->name('mis-pedidos.confirmar-recepcion');
        ...
        // Pagos QR para cuotas de crÃ©ditos (definidas abajo con middleware ampliado)
    });
});
